...
file_list += ['/tmp/canw/open-source-phy_SKY130/vlog_netlist/osc/edge_injector.sv']
file_list += ['/tmp/canw/open-source-phy_SKY130/vlog_netlist/osc/phase_interpolator.sv']
